ARG VERSION=0.0.1
ARG REPOS_PACKAGE=https://trunk.rdoproject.org/centos8/component/tripleo/current/python3-tripleo-repos-0.1.1-0.20210118183911.2cfaa48.el8.noarch.rpm
...
RUN tripleo-repos --stream -b master current-tripleo ceph
